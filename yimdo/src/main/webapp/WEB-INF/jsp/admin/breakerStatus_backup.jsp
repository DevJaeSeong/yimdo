...
function fetch_getBreakerList(pageNo) {
	...
	.then(data => {
		...
		breakerInfoVos.forEach(breakerInfoVo => {
			...
			$('#breakerList').append('<tr><td>' + breakerInfoVo.breakerId + '</td><td>' + breakerInfoVo.yimdoName + '</td><td><span class="' + breakerStatusDeco + '">' + breakerInfoVo.breakerStatusName + '</span></td><td>' + breakerInfoVo.modifier + '</td><td>' + breakerInfoVo.modifyDate + '</td><td>' + breakerInfoVo.elementName + '</td></tr>');
		})
