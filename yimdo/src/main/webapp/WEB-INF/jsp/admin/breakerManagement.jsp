	...
	.then(data => {
		...
		breakerInfoVos.forEach(breakerInfoVo => {
			...
			if (breakerPolicyDeco == breakerStatusDeco) {
				...
				$('#breakerList').append('<tr><td><ul class="checkboL"><li><div class="checkboX"><input class="breakerCheckBox" type="checkbox" value="' + breakerInfoVo.breakerId + '" id="' + breakerInfoVo.breakerId + '" name="' + breakerInfoVo.breakerId + '"><label for="' + breakerInfoVo.breakerId + '"></label></div></li></ul></td><td>' + breakerInfoVo.yimdoName + '</td><td>' + breakerInfoVo.breakerId + '</td><td><span class="' + breakerPolicyDeco + '">' + breakerInfoVo.breakerPolicyName + '</span></td><td><span class="' + breakerStatusDeco + '">' + breakerInfoVo.breakerStatusName + '</span></td><td></td></tr>');
			
			} else {

				$('#breakerList').append('<tr><td><ul class="checkboL"><li><div class="checkboX"><input class="breakerCheckBox" type="checkbox" value="' + breakerInfoVo.breakerId + '" id="' + breakerInfoVo.breakerId + '" name="' + breakerInfoVo.breakerId + '"><label for="' + breakerInfoVo.breakerId + '"></label></div></li></ul></td><td>' + breakerInfoVo.yimdoName + '</td><td>' + breakerInfoVo.breakerId + '</td><td><span class="' + breakerPolicyDeco + '">' + breakerInfoVo.breakerPolicyName + '</span></td><td><span class="' + breakerStatusDeco + '">' + breakerInfoVo.breakerStatusName + '</span></td><td>차단기 정책과 상태가 일치하지 않습니다.</td></tr>');
			}
...
function fetch_updateBreakerStatus() {
	...
	fetch("/admin/breakerManagement/updateBreakerStatus.do", {
		method: 'POST',
		headers: {
                        ...
                        <div class="sub_head">
                            <div class="loacation_area">
                                <ol>
                                    ...
                                    <li><span><strong>차단기관리</strong></span></li>
                                </ol>
                            </div>
                            <h2 class="titlesb">차단기관리</h2>
                        </div>
                        <!-- E : sub_head -->
                        ...
                        <div class="content_area mt15">
                            ...
                            <div class="sarchTxpa_box">
                                ...
                                <div class="srcR_box ">
                                    ...
                                    <a href="#none" class="btn_list_src" onclick="fetch_getBreakerList();"><span>조회</span></a>
                                </div>
                            </div>
                            <!-- E : sarchTxpa_box -->
                            <!-- S : table_typA -->
                            ...
                            <div class="mt30 mb30 btn_center">
                                <a href="#none" class="btn_list_src mr10" onclick="fetch_updateBreakerStatus();"><span>적용</span></a>
