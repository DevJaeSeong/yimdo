package egovframework.web.admin.breakerManagement.service.impl;
...
@Service("breakerManagementService")
@Slf4j
public class BreakerManagementServiceImpl implements BreakerManagementService {
